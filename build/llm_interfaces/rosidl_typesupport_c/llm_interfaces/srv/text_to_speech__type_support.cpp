...
static const _TextToSpeech_Request_type_support_symbol_names_t _TextToSpeech_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, llm_interfaces, srv, TextToSpeech_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, llm_interfaces, srv, TextToSpeech_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, llm_interfaces, srv, TextToSpeech_Request)() {
  return &::llm_interfaces::srv::rosidl_typesupport_c::TextToSpeech_Request_message_type_support_handle;
}
...
static const _TextToSpeech_Response_type_support_symbol_names_t _TextToSpeech_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, llm_interfaces, srv, TextToSpeech_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, llm_interfaces, srv, TextToSpeech_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, llm_interfaces, srv, TextToSpeech_Response)() {
  return &::llm_interfaces::srv::rosidl_typesupport_c::TextToSpeech_Response_message_type_support_handle;
}
...
static const _TextToSpeech_type_support_symbol_names_t _TextToSpeech_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, llm_interfaces, srv, TextToSpeech)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, llm_interfaces, srv, TextToSpeech)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, llm_interfaces, srv, TextToSpeech)() {
  return &::llm_interfaces::srv::rosidl_typesupport_c::TextToSpeech_service_type_support_handle;
}
