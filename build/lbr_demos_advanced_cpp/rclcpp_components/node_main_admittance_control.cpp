...
#define NODE_MAIN_LOGGER_NAME "admittance_control"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libadmittance_control_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<lbr_demos::AdmittanceControlNode>";
