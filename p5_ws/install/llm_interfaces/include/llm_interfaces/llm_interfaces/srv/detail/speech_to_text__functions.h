...
#ifndef LLM_INTERFACES__SRV__DETAIL__SPEECH_TO_TEXT__FUNCTIONS_H_
#define LLM_INTERFACES__SRV__DETAIL__SPEECH_TO_TEXT__FUNCTIONS_H_
...
/// Initialize srv/SpeechToText message.
/**
...
/// Finalize srv/SpeechToText message.
/**
...
/// Create srv/SpeechToText message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * llm_interfaces__srv__SpeechToText_Request__init().
...
/// Destroy srv/SpeechToText message.
/**
 * It calls
 * llm_interfaces__srv__SpeechToText_Request__fini()
...
/// Check for srv/SpeechToText message equality.
/**
...
/// Copy a srv/SpeechToText message.
/**
...
/// Initialize array of srv/SpeechToText messages.
/**
...
/// Finalize array of srv/SpeechToText messages.
/**
 * It calls
 * llm_interfaces__srv__SpeechToText_Request__fini()
...
/// Create array of srv/SpeechToText messages.
/**
 * It allocates the memory for the array and calls
 * llm_interfaces__srv__SpeechToText_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/SpeechToText messages.
/**
 * It calls
 * llm_interfaces__srv__SpeechToText_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/SpeechToText message array equality.
/**
...
/// Copy an array of srv/SpeechToText messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * llm_interfaces__srv__SpeechToText_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_llm_interfaces
...
/**
 * It calls
 * llm_interfaces__srv__SpeechToText_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_llm_interfaces
...
/**
 * It allocates the memory for the array and calls
 * llm_interfaces__srv__SpeechToText_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_llm_interfaces
...
/**
 * It calls
 * llm_interfaces__srv__SpeechToText_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // LLM_INTERFACES__SRV__DETAIL__SPEECH_TO_TEXT__FUNCTIONS_H_
