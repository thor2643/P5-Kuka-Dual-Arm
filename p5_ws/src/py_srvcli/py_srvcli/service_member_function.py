...
class MoveRobotInWorld(Node):
    ...
    def __init__(self, node_name: str, namespace: str) -> None: # NOTE: -> None to ensure compile error if the node tries to return anything.
        ...
        self.srv = self.create_service(GetSixInts, 'get_six_ints', self.gGetSevenInts, 'get_seven_ints')  # Client for ROS2 service

        # Wait for the service to be availts_callback)       #i know the naming convention is not up to date TODo
